package JSONArrayUsingJsonObject_List16;
...
public class JSONArrayUsingJsonObject_List {
	...
	public void createUserUsingJSONArray()
	{
		...
		user1.put("firstName", "Dilip");
		user1.put("lastName", "Raut");
		user1.put("age", 28);
		user1.put("salary", 10000.56);

		JSONObject user2 = new JSONObject();
		user2.put("firstName", "Deepak");
		user2.put("lastName", "Raut");
		user2.put("age", 28);
		user2.put("salary", 10000.56);

		JSONObject user3 = new JSONObject();
		user3.put("firstName", "Dinesh");
		user3.put("lastName", "Raut");
		user3.put("age", 28);
